...
class PluginEditor final : public juce::AudioProcessorEditor,
                           ...
                           private juce::Timer,
                           private ara::DocumentController::Listener
{
public:
...
private:
    ...
    [[nodiscard]] ara::ConversionModification* getFocusedModification() const;
    ...
    gui::PitchCurveView pitchCurveView;
