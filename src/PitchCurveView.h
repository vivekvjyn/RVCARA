...
public:
    ...
    */
    void setRenderState (ConversionModification::State state, float progress, const juce::String& message);
...
private:
    ...
    ConversionModification::State renderState { ConversionModification::State::idle };
